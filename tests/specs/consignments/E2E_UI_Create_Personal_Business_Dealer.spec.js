...
const scenarioName = scenarioNames.scenario6;
...
vehicleData.forEach((vehicle) => {
    test.describe(`Scenario: ${scenarioName}`, () => {
        test(`@regression ${vehicle.year} ${vehicle.make} ${vehicle.model}`, async () => {
            ...
            console.log('====================================');
            console.log('Starting Individual Consignment');
            console.log('====================================');
            ...
            await allure.step('Start Another Application', async () => {
                await titledocuments.startAnotherConsignment()
                logger.logInfo('Starting Another Consignment Application')
            })


            console.log('====================================');
            console.log('Starting Business Consignment');
            console.log('====================================');

            logger = new Logger(`Executing ${scenarioName}`)
            logger.logInfo('Creating Business Consignment')
            ...
            await allure.step('Add TitleTo as Business', async () => {
                logger.logStep(`Adding titled to as - ${chalk.bold.italic.green('Business')}`)
                await titledocuments.addBusinessTitledTo(accData.firstName)
            })
            ...
            await allure.step('Entering Business Information', async () => {
                logger.logStep(`Entering business information and Uploading Document- ${chalk.bold.green('Operating Agreement')}`)
                await titledocuments.businessInformation()
            })
            ...
            logger.logInfo('Business Consignment created successfully')
            ...
            console.log('====================================');
            console.log('Starting Dealer Consignment');
            console.log('====================================');
